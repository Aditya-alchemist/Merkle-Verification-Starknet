 ...
 * ```
 */
export declare const hashPair: (a: bigint, b: bigint, hashType?: HashType) => bigint;
/**
 * Compute Poseidon hash from data
 *  @param data - Array of hex string.
 * @returns format: bigint - poseidon hash
 */
export declare function computePoseidonHashOnElements(data: string[]): bigint;
/**
 ...
 * ```
 */
export declare function hashDataToHex(data: InputForMerkle, hashType?: HashType): string;
/**
 * Calculate the hash of data formatted in {@link InputForMerkle}
 ...
 * ```
 */
export declare function hashDataToBigint(data: InputForMerkle, hashType?: HashType): bigint;
/**
 * Class for handling Merkle trees.
 */
export declare class StarknetMerkleTree {
